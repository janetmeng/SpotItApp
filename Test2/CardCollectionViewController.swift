...
class CardCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        deck.shuffle()
        deck = Array(deck[...numberRounds])   //  keep from 0 until numberRounds (we need numberRounds +1 symbols at minimum). then transform the ArraySlide to a regular Array
        print("number of rounds chosen is: " + String(numberRounds))
