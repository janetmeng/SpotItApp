...
class StartGameViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        pickerData=["14 cards (1/4 deck)","28 cards (1/2 deck)","42 cards (3/4 deck)","57 cards (full deck)"]
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        let numberOfCards  = Int(pickerData[row].split(separator: " ")[0]) ??  14     // from "14 cards" -> "14" (String)  -> 14 (Integer)
